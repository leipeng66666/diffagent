...
> Same combined methodology figure as `project1_guest/figure_prompt.md`.  
> Describes the analytical framework — two symmetrical routes converging on diffusion determinants.
